...
class IsekaiScanAdapterTest < ActiveSupport::TestCase
  ...
  def setup
    ...
    @fixtures = {
      ...
      "GET #{@base_url}/ajax-list-chapter?mangaID=#{@manga_id}" => chapters_ajax_fixture,
  ...
  def test_series_extracts_author
    ...
    assert_equal "Sung-Lak Jang", series.author
  end
  ...
  def search_fixture
    <<~HTML
      <!DOCTYPE html>
      <html>
      <head><title>Search - IsekaiScan</title></head>
      <body>
        <div class="c-tabs-item__content">
          <div class="tab-thumb">
            <a href="#{@base_url}/manga/#{@series_slug}/">
              <img src="https://isekaiscan.top/wp-content/uploads/2020/cover-solo-leveling.jpg" alt="Solo Leveling" />
            </a>
          </div>
          ...
          <div class="mg_author">
            <span class="summary-content"><a href="/manga-author/sung-lak-jang/">Sung-Lak Jang</a></span>
          </div>
        </div>
        <div class="c-tabs-item__content">
          <div class="tab-thumb">
            <a href="#{@base_url}/manga/solo-leveling-ragnarok/">
              <img src="https://isekaiscan.top/wp-content/uploads/2024/cover-slr.jpg" alt="Solo Leveling: Ragnarok" />
            </a>
          </div>
          <div class="post-title">
  ...
  def series_fixture
    <<~HTML
      <!DOCTYPE html>
      <html>
      <head><title>Solo Leveling - IsekaiScan</title></head>
      <body>
        <div class="post-title">
          <h1>Solo Leveling</h1>
        </div>
        ...
        <div class="author-content">
          <a href="/manga-author/sung-lak-jang/">Sung-Lak Jang</a>
        </div>
        <div class="artist-content">
          <a href="/manga-artist/dubu/">DUBU</a>
        </div>
        ...
        <div class="description-summary">
          <div class="summary__content">
            ...
            to protect humanity, Sung Jinwoo, the weakest hunter of all, finds a hidden
            dungeon with the hardest rules.
          </div>
        </div>
        <script>var mangaID = '#{@manga_id}';</script>
  ...
  def pages_fixture
    <<~HTML
      <!DOCTYPE html>
      <html>
      <head><title>Solo Leveling Chapter 1 - IsekaiScan</title></head>
      <body>
        <div class="reading-content">
          <div class="page-break">
            <img data-src="https://isekaiscan.top/wp-content/uploads/WP-manga/data/manga_id/ch1/page-001.jpg" src="" />
          </div>
          <div class="page-break">
            <img data-src="https://isekaiscan.top/wp-content/uploads/WP-manga/data/manga_id/ch1/page-002.png" src="" />
          </div>
          <div class="page-break">
            <img data-src="https://isekaiscan.top/wp-content/uploads/WP-manga/data/manga_id/ch1/page-003.webp" src="" />
          </div>
        </div>
      </body>
      </html>
  ...
  def browse_fixture
    <<~HTML
      ...
      <div class="page-item-detail">
        <h3 class="h5">
          <a href="#{@base_url}/manga/tears-on-a-withered-flower/">Tears on a Withered Flower</a>
        </h3>
        <img src="https://isekaiscan.top/wp-content/uploads/2024/cover-towf.jpg" alt="Tears on a Withered Flower" />
      </div>
    HTML
  end
