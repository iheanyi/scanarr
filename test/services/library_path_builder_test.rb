...
class LibraryPathBuilderTest < ActiveSupport::TestCase
  def test_base_and_chapter_paths
    ...
    assert_equal "library/weeb-central/one-piece--#{series.public_id}", builder.base_path

    chapter = Chapter.create!(series: series, source: source, chapter_number: "1.5")

    expected_chapter_path = "library/weeb-central/one-piece--#{series.public_id}/chapters/1.5--#{chapter.public_id}"
    ...
    volume_chapter_path = "library/weeb-central/one-piece--#{series.public_id}/volumes/2/chapters/1.5--#{chapter.public_id}"
    ...
    assert_equal "library/weeb-central/one-piece--#{series.public_id}/covers/cover.webp", builder.cover_path(extension: "webp")
  ...
  def test_empty_slug_segments_fall_back_to_stable_values
    ...
    expected_chapter_path = "library/unknown-source/one-piece--#{series.public_id}/chapters/unknown--#{chapter.public_id}"
