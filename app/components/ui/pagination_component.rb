...
module UI
  class PaginationComponent < BaseComponent
    ...
    # @param turbo_frame [String, nil] Optional Turbo Frame target for links
    ...
    def link_data
      return { turbo_action: "advance" } if turbo_frame.blank?

      { turbo_action: "advance", turbo_frame: turbo_frame }
    end
  end
end
